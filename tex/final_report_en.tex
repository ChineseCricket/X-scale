...
Galaxy clusters are the most massive virialized systems in the late-time Universe. Their deep gravitational potentials confine an intracluster medium (ICM) with temperatures of order $10^7$--$10^8$ K. At these temperatures the gas emits strongly in X-rays through thermal bremsstrahlung and metal-line emission, making X-ray luminosity and temperature natural observables for tracing cluster mass. The project goal is to calibrate how \Lx{} and \Tx{} scale with halo mass \Mfive{}, where \Mfive{} is the mass enclosed within the radius \Rfive{} at which the mean density is 500 times the critical density at the cluster redshift.
...
\end{equation}
Equivalently, the self-similar bolometric luminosity--temperature slope is $L_{\mathrm{X}}\propto E(z)T_{\mathrm{X}}^2$. Real clusters deviate from these ideal scalings because gas cooling, AGN feedback, merger shocks, core entropy structure, gas-fraction variation, projection, and asphericity change the thermodynamic state of the ICM \citep{pratt2009,mantz2010,maughan2012}. These effects motivate explicit quality control and a comparison between full-aperture and core-excised measurements.
